...
public class BusReservationAndTicketingSystem {
    ...
    for(int i=1;i<4;){
    	...
    	if(user.equals("2") && password.equals("2")){
    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)MUMBAI CITY   | MH600|   "+available[1]+"   **");
    					System.out.println("** 2.)DELHI CITY  | MH170 |   "+available[2]+"   **");
    					System.out.println("** 3.)NAGPUR   | MH150 |   "+available[3]+"   **");
    					System.out.println("** 4.)LUCKNOW     | MH200 |   "+available[4]+"   **");
    					System.out.println("** 5.)CHENNAI     | MH250 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "MUMBAI CITY", "DELHI CITY", "NAGPUR", "LUCKNOW", "CHENNAI"};
    					...
    					if(print==1){
    						...
    						System.out.println("FARE PRICE: MH " + ticketD[z][0]);
						...
						for(x=1; x==1;){
								...
								for(int b=0;b<z;b++){
									if(search.equalsIgnoreCase(ticketS[b][0])){
	    								...
	    								System.out.println("FARE PRICE: MH" + ticketD[b][0]);
										...
										if(ticketS[b][2].equals("x")){
	    									...
	    									for(x=1; x==1;){
	    										...
	    										if(change[b]<0){
	    											...
	    											System.out.println("CHANGE: MH "+change[b]);
	    											System.out.println("");
	    											x=0;
	    										}
	    									}
    					...
    					search = in.readLine();
							...
							for(x=0; x<=z; x++){
								if(search.equalsIgnoreCase(ticketS[x][0])){
    								...
    								System.out.println("FARE PRICE: MH" + ticketD[x][0]);
    								System.out.println("NO. OF PASSENGERS: " + ticketI[x][0]);
    								System.out.println("NO. OF PASSENGERS WITH DISCOUNT: " + ticketI[x][1]);
    								System.out.println("TOTAL FARE PRICE: MH " + ticketD[x][2]);
    								if(ticketS[x][2].equals("x")){
    									System.out.println("PAY: MH " +pay[x]);
    									System.out.println("CHANGE: MH " +change[x]);
